        ...
        summary.append(
            {
                ...
                "within_1_percent_success_rate": _rate(
                    sum(bool(row.get("success_within_1_percent")) for row in ok_rows),
                    len(ok_rows),
                ),
                "within_3_percent_success_rate": _rate(
                    sum(bool(row.get("success_within_3_percent")) for row in ok_rows),
                    len(ok_rows),
                ),
                "within_5_percent_success_rate": _rate(
                    sum(bool(row.get("success_within_5_percent")) for row in ok_rows),
                    len(ok_rows),
                ),
...
def _base_run_row(
    *,
    ...
    return {
        ...
        "success_within_1_percent": None,
        "success_within_3_percent": None,
        "success_within_5_percent": None,
